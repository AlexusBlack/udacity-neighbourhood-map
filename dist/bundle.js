...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.clearMap = clearMap;\nexports.createMarker = createMarker;\nexports.loadPlaces = loadPlaces;\n\nvar _placesLoadingException = _interopRequireDefault(__webpack_require__(341));\n\nvar _mapInfoWindow = __webpack_require__(342);\n\nvar _shopIcon = _interopRequireDefault(__webpack_require__(345));\n\nvar _geekIcon = _interopRequireDefault(__webpack_require__(346));\n\nvar _restaurantIcon = _interopRequireDefault(__webpack_require__(347));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step(\"next\", value); } function _throw(err) { step(\"throw\", err); } _next(); }); }; }\n\n/**\n * Clear google maps from markers and infoWindows\n * \n * @param {googleMapObj} map \n */\nfunction clearMap(map) {\n  if (!(map.markers == null)) {\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = map.markers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var _marker = _step.value;\n\n        // closing info windows if open\n        if (!(_marker.infoWindow == null)) {\n          _marker.infoWindow.close();\n        } // removing marker\n\n\n        _marker.setMap(null);\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator.return != null) {\n          _iterator.return();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n  } // cleaning markers storage\n\n\n  map.markers = [];\n}\n/**\n * Returns icon for provided place,\n * which is determined by place category\n * \n * @param {place} place \n * @returns \n */\n\n\nfunction getPlaceIcon(place) {\n  if (place.category == 'groceries') {\n    return _shopIcon.default;\n  } else if (place.category == 'geeks') {\n    return _geekIcon.default;\n  } else if (place.category == 'restorant') {\n    return _restaurantIcon.default;\n  }\n}\n/**\n * Returns marker for the provided place\n * \n * @param {place} place \n * @returns Marker\n */\n\n\nfunction createMarker(place) {\n  var marker = new google.maps.Marker({\n    position: place.location,\n    map: null,\n    title: place.name,\n    icon: getPlaceIcon(place)\n  });\n  place.active.subscribe(function (active) {\n    if (active) {\n      (0, _mapInfoWindow.showInfoWindow)(place);\n    } else {\n      (0, _mapInfoWindow.closeInfoWindow)(place);\n    }\n  });\n  marker.addListener('click', function () {\n    return place.active(true);\n  });\n  return marker;\n}\n/**\n * Loads places from JSON file asyncronously\n * \n * @returns Promise(Array(Places))\n */\n\n\nfunction loadPlaces() {\n  return _loadPlaces.apply(this, arguments);\n}\n\nfunction _loadPlaces() {\n  _loadPlaces = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var response, placesList;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return fetch('./places.json');\n\n          case 3:\n            response = _context.sent;\n            _context.next = 9;\n            break;\n\n          case 6:\n            _context.prev = 6;\n            _context.t0 = _context[\"catch\"](0);\n            throw new _placesLoadingException.default('Looks like there was a problem with loading places list.' + _context.t0.message);\n\n          case 9:\n            if (!(response.status !== 200)) {\n              _context.next = 11;\n              break;\n            }\n\n            throw new _placesLoadingException.default('Looks like there was a problem with loading places list. Status Code: ' + response.status);\n\n          case 11:\n            _context.next = 13;\n            return response.json();\n\n          case 13:\n            placesList = _context.sent;\n            return _context.abrupt(\"return\", placesList);\n\n          case 15:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[0, 6]]);\n  }));\n  return _loadPlaces.apply(this, arguments);\n}\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/utils/tools.js\n// module id = 128\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/utils/tools.js?");
...
"use strict";
eval("\n\n__webpack_require__(130);\n\n__webpack_require__(332);\n\n__webpack_require__(335);\n\nvar _appModel = _interopRequireDefault(__webpack_require__(339));\n\nvar _mapSettings = _interopRequireDefault(__webpack_require__(350));\n\nvar _mapMarkers = _interopRequireDefault(__webpack_require__(351));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n// Loading custom bindings for Google Maps\nko.bindingHandlers.mapSettings = (0, _mapSettings.default)();\nko.bindingHandlers.mapMarkers = (0, _mapMarkers.default)(); // Initializing model and applying it\n\nvar model = new _appModel.default();\nko.applyBindings(model); // Loading places from JSON\n\nmodel.loadPlaces();\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/app.js\n// module id = 129\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/app.js?");
...
eval("module.exports = \"dist/assets/3f0f071bec392bff23c5bd3797688e23.svg\";\n\n//////////////////\n// WEBPACK FOOTER\n// ./img/map-unavailable-icon.svg\n// module id = 338\n// module chunks = 0\n\n//# sourceURL=webpack:///./img/map-unavailable-icon.svg?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = AppModel;\n\nvar _filters = _interopRequireDefault(__webpack_require__(340));\n\nvar _tools = __webpack_require__(128);\n\nvar _mdlDialog = _interopRequireDefault(__webpack_require__(90));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step(\"next\", value); } function _throw(err) { step(\"throw\", err); } _next(); }); }; }\n\n/**\n * View\\Data Model of our app\n * \n * @export\n */\nfunction AppModel() {\n  var _this = this;\n\n  var self = this; // If we cannot load places this is critical error that we must reflect in model\n\n  this.errorLoadingPlaces = ko.observable(false); // Initial settings for map\n\n  this.map = ko.observable({\n    center: {\n      lat: -37.821410,\n      lng: 144.959343\n    },\n    zoom: 15\n  }); // Filter, default value comes from localStorage or it is empty\n\n  this.filter = ko.observable(localStorage.searchString || '');\n  this.filter.subscribe(function (searchString) {\n    // Saving our search string to localStorage\n    localStorage.searchString = searchString;\n  }); // Our list of place\n\n  this.places = ko.observableArray([]); // List of places, filtered\n\n  this.filteredPlaces = ko.computed(function () {\n    if (!self.filter()) {\n      return self.places();\n    }\n\n    return ko.utils.arrayFilter(self.places(), function (place) {\n      return (0, _filters.default)(place, self.filter());\n    });\n  });\n  /**\n   * Load list of places\n   */\n\n  this.loadPlaces =\n  /*#__PURE__*/\n  _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var places;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _this.errorLoadingPlaces(false);\n\n            _context.prev = 1;\n            _context.next = 4;\n            return (0, _tools.loadPlaces)();\n\n          case 4:\n            places = _context.sent;\n\n            _this.addPlace.apply(_this, _toConsumableArray(places));\n\n            _context.next = 12;\n            break;\n\n          case 8:\n            _context.prev = 8;\n            _context.t0 = _context[\"catch\"](1);\n\n            _this.errorLoadingPlaces(true);\n\n            if (_context.t0.name == 'PlacesLoadingException') {\n              _mdlDialog.default.show('Error while loading places list, you can try reload it with button in sidebar.');\n            } else {\n              _mdlDialog.default.show('Unknown error happened');\n\n              console.error(_context.t0.message, _context.t0);\n            }\n\n          case 12:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[1, 8]]);\n  }));\n  /**\n   * Add one or multiple places\n   * @param {*} placesInfo \n   */\n\n  this.addPlace = function () {\n    var _this2 = this;\n\n    for (var _len = arguments.length, placesInfo = new Array(_len), _key = 0; _key < _len; _key++) {\n      placesInfo[_key] = arguments[_key];\n    }\n\n    var _loop = function _loop(placeInfo) {\n      var place = {\n        name: placeInfo.name,\n        location: placeInfo.location,\n        category: placeInfo.category,\n        active: ko.observable(false)\n      };\n      place.active.subscribe(function (state) {\n        return placeActiveStateChanged.call(_this2, place, state);\n      });\n\n      _this2.places.push(place);\n    };\n\n    for (var _i = 0; _i < placesInfo.length; _i++) {\n      var placeInfo = placesInfo[_i];\n\n      _loop(placeInfo);\n    }\n  };\n  /**\n   * Click handler to activate place\n   * @param {place} e \n   */\n\n\n  this.selectPlace = function (e) {\n    this.active(true);\n  };\n  /**\n   * When place becomes active, we are making every other inactive\n   * \n   * @param {place} changedPlace \n   * @param {Boolean} state \n   * @returns \n   */\n\n\n  function placeActiveStateChanged(changedPlace, state) {\n    if (state == false) return; // only one place can be active at the time\n\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = this.places()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var _place = _step.value;\n\n        if (_place != changedPlace) {\n          _place.active(false);\n        }\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator.return != null) {\n          _iterator.return();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n  }\n}\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/app-model.js\n// module id = 339\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/app-model.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = PlacesLoadingException;\n\n/**\n * This exception raised when we were unable to load places list\n * \n * @export\n * @param {String} message \n */\nfunction PlacesLoadingException(message) {\n  this.message = message;\n  this.name = 'PlacesLoadingException';\n}\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/exceptions/places-loading-exception.js\n// module id = 341\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/exceptions/places-loading-exception.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = getFoursquareData;\n\nvar _foursquareLoadingException = _interopRequireDefault(__webpack_require__(344));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step(\"next\", value); } function _throw(err) { step(\"throw\", err); } _next(); }); }; }\n\nvar FOURSQUARE_CLIENT_ID = '1TJBD0BFMGT5FJFTNVLRZSP2PLEMDOC0GOFQAJ3NGDY0TTB5';\nvar FOURSQUARE_CLIENT_SECRET = '3NAQ2TJEZ2ZAWHMZ1BKSVQ00WKA325VCADGWQZ2N1WC1BETZ';\n/**\n * Gets info about place from Foursquare API\n * \n * @export\n * @param {place} place \n * @returns Object with info including address, city, phone and formatted phone\n */\n\nfunction getFoursquareData(_x) {\n  return _getFoursquareData.apply(this, arguments);\n}\n\nfunction _getFoursquareData() {\n  _getFoursquareData = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(place) {\n    var response, data, placeData, info;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return fetch(\"https://api.foursquare.com/v2/venues/search?\" + \"ll=\".concat(place.location.lat, \",\").concat(place.location.lng, \"&query=\").concat(place.name, \"&\") + \"client_id=\".concat(FOURSQUARE_CLIENT_ID, \"&client_secret=\").concat(FOURSQUARE_CLIENT_SECRET, \"&v=20180122\"));\n\n          case 3:\n            response = _context.sent;\n            _context.next = 9;\n            break;\n\n          case 6:\n            _context.prev = 6;\n            _context.t0 = _context[\"catch\"](0);\n            throw new _foursquareLoadingException.default('Unable to access foursquare ' + _context.t0.message);\n\n          case 9:\n            if (!(response.status !== 200)) {\n              _context.next = 12;\n              break;\n            }\n\n            throw new _foursquareLoadingException.default('Looks like there was a problem with loading foursquare info. Status Code: ' + response.status);\n\n          case 12:\n            _context.next = 14;\n            return response.json();\n\n          case 14:\n            data = _context.sent;\n            placeData = data.response.venues[0];\n            info = {\n              address: placeData.location.address,\n              city: placeData.location.city,\n              phone: placeData.contact.phone,\n              formattedPhone: placeData.contact.formattedPhone\n            };\n            return _context.abrupt(\"return\", info);\n\n          case 18:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this, [[0, 6]]);\n  }));\n  return _getFoursquareData.apply(this, arguments);\n}\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/utils/foursquare-api.js\n// module id = 343\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/utils/foursquare-api.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = mapMarkers;\n\nvar _tools = __webpack_require__(128);\n\nvar _mdlDialog = _interopRequireDefault(__webpack_require__(90));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n/**\n * Knockout.js for data binding of places to google maps markers\n * \n * @export\n * @returns \n */\nfunction mapMarkers() {\n  return {\n    update: function update(element, valueAccessor, allBindingsAccessor, viewModel) {\n      var map = element; // Unwrapping markers list\n\n      var placesList = ko.utils.unwrapObservable(valueAccessor());\n\n      var createMarkers = function createMarkers() {\n        // Cleaning old markers\n        (0, _tools.clearMap)(map);\n        var _iteratorNormalCompletion = true;\n        var _didIteratorError = false;\n        var _iteratorError = undefined;\n\n        try {\n          for (var _iterator = placesList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n            var _place = _step.value;\n\n            if (_place.marker == null) {\n              _place.marker = (0, _tools.createMarker)(_place);\n            }\n\n            _place.marker.setMap(map.googleMap);\n\n            map.markers.push(_place.marker);\n          }\n        } catch (err) {\n          _didIteratorError = true;\n          _iteratorError = err;\n        } finally {\n          try {\n            if (!_iteratorNormalCompletion && _iterator.return != null) {\n              _iterator.return();\n            }\n          } finally {\n            if (_didIteratorError) {\n              throw _iteratorError;\n            }\n          }\n        }\n      };\n\n      if (typeof google != 'undefined') {\n        google.maps.event.addDomListener(window, 'load', function () {\n          return createMarkers();\n        });\n      }\n\n      document.addEventListener('MapsReadyEvent', createMarkers);\n    }\n  };\n}\n\n//////////////////\n// WEBPACK FOOTER\n// ./src/custom-bindings/map-markers.js\n// module id = 351\n// module chunks = 0\n\n//# sourceURL=webpack:///./src/custom-bindings/map-markers.js?");
